        ...
        <div className="space-y-6">
          <div>
            ...
            <div className="bg-gray-100 p-4 rounded-lg">
              <code className="text-[13px] text-black">
                Оцени [что именно] в диапазоне от -2 до +2, где:<br/>
                -2 = [очень плохо]<br/>
                -1 = [плохо]<br/>
                0 = [нейтрально]<br/>
                +1 = [хорошо]<br/>
            ...
            <div className="space-y-4">
              <div className="border border-gray-200 rounded-lg p-4">
                ...
                <p className="text-[13px] text-gray-700">
                  Оцени структурированность материала от -2 до +2. Проверь наличие логичного введения, 
                  основной части и выводов. Обрати внимание на переходы между темами и общую организацию контента.
                </p>
              </div>

              <div className="border border-gray-200 rounded-lg p-4">
                <h4 className="text-[14px] font-medium text-black mb-2">🎯 Практическая применимость</h4>
                <p className="text-[13px] text-gray-700">
                  Оцени практическую ценность материала от -2 до +2. Есть ли конкретные примеры, 
                  пошаговые инструкции, реальные кейсы? Сможет ли студент применить знания на практике?
                </p>
              </div>
          ...
          <div>
            ...
            <p className="text-[14px] text-gray-700">
              Система автоматически добавит к вашему промпту запрос на детальный анализ в формате JSON, 
              включая примеры из текста и рекомендации по улучшению. Вам нужно только описать критерий оценки.
            </p>
          </div>

          <div className="bg-blue-50 p-4 rounded-lg">
            <p className="text-[14px] text-blue-800">
              <strong>Совет:</strong> Чем конкретнее ваш промпт, тем точнее будет анализ. 
              Избегайте слишком общих формулировок вроде "оцени качество".
            </p>
          </div>
        </div>

...
describe('SecretBox Encryption', () => {
  ...
  describe('decrypt', () => {
    ...
    it('should throw error for null encrypted data', () => {
      expect(() => decrypt(null as any, testPassword)).toThrow('Encrypted data and password are required')
    })
  })
  ...
  describe('encryptForStorage and decryptFromStorage', () => {
    ...
    it('should fail decryption with invalid JSON', () => {
      expect(() => decryptFromStorage('not-json', testPassword)).toThrow('Invalid encrypted data format')
    })
  })
